...
public class TicketSearchPanel extends JPanel implements ActionListener,MouseListener{
	...
	private void init() {
		try {
			ticketSearchPanel = new ImagePanel(ImageIO.read(new File("plane/image/ticketsearch.jpg")),new Dimension(Tookit.getScreen().width-100,Tookit.getScreen().height-100)) ;
