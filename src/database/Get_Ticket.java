...
public class Get_Ticket {
    ...
    public void getUserTicket(Connection conn, Customer customer, Ticket[] ticket) {
        int cusID = customer.getID();
        // SQL查询语句，根据cusID查找相关的票
        String SQL = "SELECT * FROM ticket WHERE Customer_ID=?";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                t.setCheci_ID(rs.getString("Checi_ID"));
                t.setLocation(rs.getString("location"));
                t.setStartStation(rs.getString("startStation"));
                t.setEndingStation(rs.getString("endingStation"));
                t.setWay(rs.getString("way"));
                t.setTickId(rs.getString("Ticket_ID"));
                t.setNumber(rs.getInt("Number"));
                t.setData(rs.getString("data"));
                t.setStarTime(rs.getString("StarTime"));
                t.setEndTime(rs.getString("EndingTime"));
